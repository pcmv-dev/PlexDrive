#!/bin/bash
# This will add Rclone to crontab
...
RCLONE CRONTAB
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 This will add "plexdrive-upload" to crontab
 To view your cronjobs type in terminal "crontab -l"
 If you need to edit the schedule type in terminal "crontab -e"
 Logs are located in "/opt/rclone/logs"
[1] Add Rclone upload schedule
[2] Reset crontab (Warning! This removes all cronjobs!)
[3] Cancel/Exit
EOF
...
if [ "$typed" == "1" ]; then
    ...
    (crontab -l 2>/dev/null; echo "*/${minute} * * * * /opt/plexdrive/plexdrive-upload 2>&1") | crontab -
    echo
    crontab -l
